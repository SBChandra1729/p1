...
class train:
    def __init__(self,name = '', num = 0, arr_time = '',dep_time = '',src = '' ,des = '',day_of_travel = '',seat_free_in_1AC = 0,seat_free_in_2AC = 0,seat_free_in_SL = 0,fare_1ac = 0, fare_2ac = 0 ,fare_sl = 0):
        self.name = name
        self.num = num
        ...
        self.seats = {'1AC' : seat_free_in_1AC, '2AC': seat_free_in_2AC,'SL': seat_free_in_SL}
        self.fare = {'1AC' : fare_1ac,'2AC' : fare_2ac ,'SL' : fare_sl}
    def print_seat_availablity(self):
    	print("No. of seats free in 1AC :- "+str(self.seats['1AC']))
    	print("No. of seats free in 2AC :- "+str(self.seats['2AC']))
    	print("No. of seats free in SL :- "+str(self.seats['SL']))
...
t1 = train('hyderabad',12345,'11:36','22:12','hyd','ong','Wed',30,23,43,2205,320,234)
t2 = train('ongol',12565,'12:34','13:16','ong','hyd','Mon',33,4,12,3434,435,234)
t3 = train('warangal',22353,'21:56','13:12','ong','hyd','Fri',33,24,77,455,325,533)
trains = {t1.num:t1,t2.num:t2,t3.num:t3}
u1 = user(1111,'schandra','hyd','999955555','chandra')
u2 = user(2322,'nikki','ongol','756985632','sainikki')
